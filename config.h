...
static unsigned int gappoh    = 40;       /* horiz outer gap between windows and screen edge */
...
static Key keys[] = {
	...
	{ MODKEY,			XK_Page_Up,	spawn,	{.v = (const char*[]){ "dmenuunicode", NULL } } },
	...
	{ MODKEY|ShiftMask,		XK_End,	spawn,		{.v = (const char*[]){ "sysact", NULL } } },
	...
	{ MODKEY|ShiftMask,			XK_r,		spawn,		{.v = (const char*[]){ "spacefm", NULL } } },
	{ MODKEY|ShiftMask,		XK_Delete,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "htop", NULL } } },
	...
	{ MODKEY|ShiftMask,			XK_v,		spawn,		{.v = (const char*[]){ "geany", NULL } } },
	{ MODKEY,		XK_n,		spawn,		SHCMD(TERMINAL " -e newsboat ; pkill -RTMIN+6 dwmblocks") },

	// music (ncmpmpp)
	{ MODKEY,			XK_F7,			spawn,		{.v = (const char*[]){ "mpc", "toggle", NULL } } },
	{ MODKEY|ShiftMask,		XK_F7,			spawn,		SHCMD("mpc pause; pauseallmpv") },
	{ MODKEY|ShiftMask,			XK_F6,	spawn,		{.v = (const char*[]){ "mpc", "prev", NULL } } },
	{ MODKEY,		XK_F6,	spawn,		{.v = (const char*[]){ "mpc", "seek", "0%", NULL } } },
	{ MODKEY,			XK_F8,	spawn,		{.v = (const char*[]){ "mpc", "next", NULL } } },
	{ MODKEY|ShiftMask,		XK_F8,	spawn,		{.v = (const char*[]){ "mpc", "repeat", NULL } } },
	...
	{ MODKEY|ShiftMask,		XK_F10,	spawn,		SHCMD("pamixer --allow-boost -d 15; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_F11,	spawn,		SHCMD("pamixer --allow-boost -i 5; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_F11,	spawn,		SHCMD("pamixer --allow-boost -i 15; kill -44 $(pidof dwmblocks)") },
	...
	// { MODKEY,			XK_Insert,	spawn,		SHCMD("xdotool type $(grep -v '^#' ~jst/.local/share/larbs/snippets | dmenu -i -l 50 | cut -d' ' -f1)") },
	...
	{ MODKEY,			XK_Insert,		spawn,		{.v = (const char*[]){ "dmenumount", NULL } } },
	{ MODKEY,			XK_Delete,		spawn,		{.v = (const char*[]){ "dmenuumount", NULL } } },
